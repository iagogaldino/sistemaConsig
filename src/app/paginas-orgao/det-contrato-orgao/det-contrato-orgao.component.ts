...
@Component({
  selector: 'app-det-contrato-orgao',
  templateUrl: './det-contrato-orgao.component.html',
  styleUrls: ['./det-contrato-orgao.component.css']
})
export class DetContratoOrgaoComponent implements OnInit {
